...
($\rho(0)\approx+0{,}5$) y un valle negativo (el mínimo de la CCF) en el rezago~4
($\approx-0{,}2$), que vuelve a cero hacia el rezago 6 (Fig.~\ref{fig:ccf}). Un
estudio de evento sobre las recesiones NBER (alineadas en el valle de la inversión) es
consistente con el patrón cualitativo ---las ganancias tienden a girar a la baja antes que la
inversión, que sigue corriendo por delante en el tramo previo al valle (el \emph{buildup} de
sobreacumulación)---, aunque el adelanto exacto es sensible al anclaje del evento, otra señal de
la debilidad de la señal. El máximo de la CCF está en el rezago~0, no a un cuarto de ciclo de atraso como
